...
class NLPClassificationSystem:
    ...
    def getTargetRegexes(self):
        target_regexes = []
        with open('./KB/NIMH_target_1116_su.csv', 'r') as f1:      #NIMH_target_1116.csv
    ...
    def target_score(self):
        ann_target_score = pd.read_csv("./KB/NIMH_target_score_1116_su.csv", sep='$') 
        score1 = dict()
...
result_data_frame.to_csv('./results/ann_table_1116_su.csv', index=False)
print('Done')
...
#%%
#ann_table = pd.read_csv('./results/ann_table_1116_su.csv')
#%%
# Read csv to dataframe and change to a dictionary with keywords and their score.
ann_target_score = pd.read_csv("./KB/NIMH_target_score_1116_su.csv", sep='$') #, index_col=0)   # to lowercase
...
ann2.to_csv("./results/ann_table_sum_1116_su1.csv")   
ann2.to_csv("./results/ann_table_sum_sep_1116_su1.csv", sep='|', index=False)
...
ann3.to_csv("./results/ann_table_sum_n_1116_su1.csv")

#%%
# Test
table1 = pd.read_csv("./results/ann_table_sum_1116_su1.csv")
table2 = pd.read_csv("./results/ann_table_sum_sep_1116_su1.csv", sep='|')
#%%
