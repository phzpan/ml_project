...
ann2.to_csv("./results/ann_table_sum_1116_su.csv")   
ann2.to_csv("./results/ann_table_sum_sep_1116_su.csv", sep='|', index=False)
...
ann3.to_csv("./results/ann_table_sum_n_1116_su.csv")

#%%
# Test
table1 = pd.read_csv("./results/ann_table_sum_1116_su.csv")
table2 = pd.read_csv("./results/ann_table_sum_sep_1116_su.csv", sep='|')
#%%
