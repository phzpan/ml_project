...
class NLPClassificationSystem:
    ...
    def getTargetRegexes(self):
        target_regexes = []
        with open('./KB/NIMH_target_1116_ax.csv', 'r') as f1:      #NIMH_target_1116.csv
...
result_data_frame.to_csv('./results/ann_table_1116_ax.csv', index=False)
print('Done')
...
ann2.to_csv("./results/ann_table_sum_1116_ax.csv")   
ann2.to_csv("./results/ann_table_sum_sep_1116_ax.csv", sep='|', index=False)
...
ann3.to_csv("./results/ann_table_sum_n_1116_ax.csv")

#%%
# Test
table1 = pd.read_csv("./results/ann_table_sum_1116_ax.csv")
table2 = pd.read_csv("./results/ann_table_sum_sep_1116_ax.csv", sep='|')
#%%
