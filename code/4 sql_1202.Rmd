...
```{r}
open_csv1 = './KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score_size_su1.csv'
open_csv2 = './results/ann_table_sum_1116_su1.csv'
#open_csv11 = './KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score_size_axis.csv'
#open_csv21 = './results/ann_table_sum_1116_ax.csv'

save_sql_table1 = 'pat_visit_standard_score_1202'
drop_sql_table1 = 'DROP TABLE IF EXISTS pat_visit_standard_score_1202'

save_sql_table2 = 'notes_score_1202'
drop_sql_table2 = 'DROP TABLE IF EXISTS notes_score_1202'

save_sql_table3 = 'pat_visit_score_match_1202'
drop_sql_table3 = 'DROP TABLE IF EXISTS pat_visit_score_match_1202'

save_csv1 = './results/score_validation_sql_1202.csv'
save_csv2 = './results/score_validation_sep_sql_1202.csv'
...
SELECT  notes.pat_visit AS pat_visit, 
        ...
        std1.fsize AS fsize
FROM    u.notes_score_1202 AS notes
JOIN    u.pat_visit_standard_score_1202 AS std1 ON  std1."PAT_VISIT" = notes.pat_visit
