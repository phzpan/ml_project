...
std['r_score'] = se.values

#%%
 
std.to_csv('./KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score.csv', index=False)

#%%
# add files size to the dataframe table

std1 = pd.read_csv("./KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score.csv")
...
#%%
std1.to_csv('./KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score_size.csv', index=False)
