...
std.to_csv('./KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score_su.csv', index=False)

#%%
# add files size to the dataframe table

std1 = pd.read_csv("./KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score_su.csv")
...
#%%
std1.to_csv('./KB/371-KIOUS-Patient-Grid-Plain-fill_1116_score_size_su.csv', index=False)
